...
<head>
    ...
    <link rel="icon" type="image/png" href="assets/img/LogoTaruna.png"/>
    <title><?= $title; ?> | SMK Taruna Wiyatamandala</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-primary sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="<?= base_url('dashboard'); ?>">
                ...
                <div class="sidebar-brand-icon">
                  ...
                  <i aria-hidden="true"><img src="<?= base_url(); ?>assets/img/LogoTaruna.png" width="40px"></i>
                </div>
            ...
            <!-- Nav Item - Dashboard -->
             <li class="nav-item  bg-primary">
                <a class="nav-link text-white" href="<?= base_url('dashboard'); ?> ">
                    <span><b>SMK Taruna Wiyatamandala</b></span>
                </a>
            </li>
            ...
            <!-- Heading -->
            <i><div class="sidebar-heading bg-primary">
                <font color="#fff"><i>Guru/Staff</i></font>
            </div></i>

            <!-- Nav Item - Dashboard -->
           <li class="nav-item bg-primary">
                <a class="nav-link pb-0 text-white" href="<?= base_url('guru'); ?>">
                    <i class="fas fa-fw fa-users"></i>
                    <span><b>Data Guru</b></span>
                </a>
            </li>
            <li class="nav-item bg-primary">
                <a class="nav-link pb-0 text-white" href="<?= base_url('guru/add'); ?>">
                    <i class="fas fa-fw fa-user-plus"></i>
                    <span><b>Tambah Guru</b></span>
                </a>
            </li>
            <hr class="sidebar-divider">
            <!-- Heading -->
            <i><div class="sidebar-heading bg-primary">
                <font color="#fff"><i>Siswa</i></font>
            </div></i>

            <!-- Nav Item - Dashboard -->
             <li class="nav-item bg-primary">
                <a class="nav-link pb-0 text-white" href="<?= base_url('siswa'); ?>">
                    <i class="fas fa-fw fa-users"></i>
                    <span><b>Data Siswa</b></span>
                </a>
            </li>
            <li class="nav-item bg-primary">
                <a class="nav-link pb-0 text-white" href="<?= base_url('siswa/add'); ?>">
                    <i class="fas fa-fw fa-user-plus"></i>
            ...
            <!-- Heading -->
            <i><div class="sidebar-heading bg-primary">
                <font color="#fff"><i>Inbox</i></font>
            </div></i>

            <!-- Nav Item - Dashboard -->
             <li class="nav-item bg-primary">
                <a class="nav-link pb-0 text-white" href="<?= base_url('inbox'); ?>">
                    <i class="fas fa-fw fa-users"></i>
                    <span><b>Kotak Masuk</b></span>
                </a>
            </li>
            ...
            <?php if (is_admin()) : ?>
                ...
                <!-- Heading -->
            <i><div class="sidebar-heading bg-primary">
                <font color="#fff"><i>Setting</i></font>
            </div></i>
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="<?= base_url('user/add'); ?>">
                        <i class="fas fa-fw fa-user-plus"></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Footer -->
            <footer class="sticky-footer bg-light" style="margin-top: 220px;position: relative;">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span style="color:#000">Copyright &copy; SMK Taruna Wiyatamandala &bull; <?= date('Y') ?> &bull; by <?= anchor('home', 'Tech_Info19'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
