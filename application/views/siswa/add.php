        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('siswa'); ?>" name="siswa" id="siswa" type="text" class="form-control">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('nama_siswa'); ?>" name="nama_siswa" id="nama_siswa" type="text" class="form-control" placeholder="Nama Siswa...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <div class="custom-control custom-radio">
                            <input <?= set_radio('kelas', 'X'); ?> value="X" type="radio" id="X" name="kelas" class="custom-control-input">
                            <label class="custom-control-label" for="X">X</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input <?= set_radio('kelas', 'XI'); ?> value="XI" type="radio" id="XI" name="kelas" class="custom-control-input">
                            <label class="custom-control-label" for="XI">XI</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input <?= set_radio('kelas', 'XII'); ?> value="XII" type="radio" id="XII" name="kelas" class="custom-control-input">
                 ...
                 <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <div class="custom-control custom-radio">
                            <input <?= set_radio('jurusan', 'RPL'); ?> value="RPL" type="radio" id="RPL" name="jurusan" class="custom-control-input">
                            <label class="custom-control-label" for="RPL">RPL (Rekayasa Perangkat Lunak)</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input <?= set_radio('jurusan', 'TKR'); ?> value="TKR" type="radio" id="TKR" name="jurusan" class="custom-control-input">
                            <label class="custom-control-label" for="TKR">TKR (Teknik Kendaraan Ringan)</label>
                        </div>
                       <div class="custom-control custom-radio">
                            <input <?= set_radio('jurusan', 'TEI'); ?> value="TEI" type="radio" id="TEI" name="jurusan" class="custom-control-input">
